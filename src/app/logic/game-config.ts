...
export const CANVAS_HEIGHT_METERS = 15;
...
export const GRACE_PERIOD_SECONDS = 0.5;
export const GROUND_HEIGHT_METERS = 0.5;
export const SHAKE_DELAY_MS = 50;
export const GROUND_THICKNESS_METERS = 0.25;
export const GROUND_WIDTH_METERS = 8;
